          ...
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li className="nav-item dropdown">
              ...
              <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                <li><Link className="dropdown-item" to="/bookings/active">Active Reservations</Link></li>
                <li><Link className="dropdown-item" to="/bookings/completed">Completed Reservations</Link></li>
              </ul>
            </li>
            <li className="nav-item">
