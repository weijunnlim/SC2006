...
const getRestaurantReservations = async (req, res) =>{
    ...
    try{
        ...
        reservation_collections.forEach(doc => {
            ...
            if (!Reservation.isOver(data.date_reservation, data.time_reservation)){
        ...
        // else if (past_reservations.length === 0){
        //     res.status(200).json({message: "You have no past reservations"})
        // }
        else{
